...
type MetricGRPCClient interface {
	GetNodeScore(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *metricGRPCClient) GetNodeScore(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/score.MetricGRPC/GetNodeScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricGRPCServer interface {
	GetNodeScore(context.Context, *Request) (*Response, error)
...
func (UnimplementedMetricGRPCServer) GetNodeScore(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNodeScore not implemented")
}
...
func _MetricGRPC_GetNodeScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetricGRPCServer).GetNodeScore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/score.MetricGRPC/GetNodeScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricGRPCServer).GetNodeScore(ctx, req.(*Request))
	}
...
var MetricGRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetNodeScore",
			Handler:    _MetricGRPC_GetNodeScore_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/h_proto/score.proto",
}
